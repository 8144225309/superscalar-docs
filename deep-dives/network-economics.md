...
| 16 clients | 10 vbytes | 15× cheaper |
| 32 clients | 5 vbytes | 31× cheaper |
...
If APO (BIP-118) activates, the rotation funding transaction cost drops to zero for cooperative rotations. On-chain transactions occur only when clients enter or exit the factory. Per-user annual on-chain cost approaches zero for long-lived clients.
